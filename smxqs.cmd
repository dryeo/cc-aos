...
dst = 'C:\work\cc45esr\obj-sm\dist\bin'
...
Main:
  ...
  /* process all the subdirectories except for "dist" */
...
/*  call ProcessFile(srcRoot || '\' || srcExe1)
  call ProcessFile(srcRoot || '\' || srcExe2) */
